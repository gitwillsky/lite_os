...
- 81 个 Linux/riscv64 syscall number；credentials/permission、UART/TTY、anonymous pipe、ppoll、标准链接、getrandom、sysinfo/statfs、uname/realtime 与 system reset 统一经过各自的单一 owner，未实现编号返回 `-ENOSYS`。
