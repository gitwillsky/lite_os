use crate::protocol::*;
use crate::{uds_connect, write, shm_create, shm_map, shm_close, mmap_flags, munmap};
...
impl ShmBuffer {
    pub fn new(width: u32, height: u32) -> Option<Self> {
        ...
        if va <= 0 { let _ = shm_close(handle as usize); return None; }
        Some(Self { handle, va, size, width, height, stride })
    }
    pub fn ptr_mut(&self) -> *mut u8 { self.va as *mut u8 }
}
