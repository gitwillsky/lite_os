...
| Terminal font | JetBrains Mono `2.304`；官方 zip SHA-256 `6f6376c6ed2960ea8a963cd7387ec9d76e3f629125bc33d1fdcd7eb7012f7bbf`；`JetBrainsMonoNL-{Medium,Bold}.ttf` SHA-256 分别为 `44099e1efefba55637e0abbbf8dd3f526e59523345888a257bb01d39df4af74c`、`0198e841824025f8876e5c297f0b9b497ee8d6eb9969710a3328e1303f996ec3`；SIL OFL 1.1 | [官方 release](https://github.com/JetBrains/JetBrainsMono/releases/tag/v2.304)、[固定 tag](https://github.com/JetBrains/JetBrainsMono/tree/v2.304) | 显式 generator 的唯一 terminal source；产出固定 468 glyph、16×32 Medium/Bold A8 atlas（SHA-256 `bbc87d129cbb440dd76eceef02755cb36d66e9a37f00ba01b615a4d7cb87abdd`），v2 header 唯一定义 session-invariant cell metrics；普通构建只嵌入 atlas，TTF 不进入 rootfs |
| Terminal control | ECMA-48 Fifth Edition，June 1991；terminfo 使用 ncurses 6.5 source format | [ECMA-48](https://ecma-international.org/publications-and-standards/standards/ecma-48/)、[ncurses terminfo](https://invisible-island.net/ncurses/man/terminfo.5.html) | `console-session` parser/control semantics 与 `TERM=liteos` capability declaration；未登记的 DEC/Kitty extension 不得标记为 complete |
