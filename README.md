...
- 带标准 JBD2 metadata journal 的读写 ext2 revision 1 启动卷与 boot-time devfs/procfs mount；统一 opened-entry/OFD 模型覆盖 regular file、directory、symlink、pipe、`/dev/null|zero|tty|console`、`/proc/<pid>/fd` 与 `/dev/fd`。
