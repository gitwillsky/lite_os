...
UI_REQUIRED_OUTPUTS = (
    ...
    "music-player/assets/monitor.png",
...
UI_EXTERNAL_INPUTS = (
    ...
    ROOT / "assets/aurora/monitor.png",
    ROOT / "assets/aurora/nav-back.png",
    ROOT / "assets/aurora/nav-forward.png",
    ROOT / "assets/aurora/nav-up.png",
...
def create_image(
    ...
    for asset in (
        ...
        "/usr/share/liteos/apps/music-player/assets/monitor.png",
